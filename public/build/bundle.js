...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$4, 67, 0, 2224);
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, ballsInRobot, $$value => $$invalidate(14, $ballsInRobot = $$value));
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(circle, "fill", "red");
    			add_location(circle, file$3, 64, 0, 1875);
    			attr_dev(svg, "id", "Layer_1");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1$1.warn(`<Cargo> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*milliCount, coords*/ 5) {
    			{
    				checkInside();
    ...
    class Cargo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*coords*/ ctx[0] === undefined && !('coords' in props)) {
    			console_1$1.warn("<Cargo> was created without expected prop 'coords'");
    		}
    	}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<CargoOnField> was created with unknown prop '${key}'`);
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$1, 14, 79, 614);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "class", "fixed overflow-visible");
    			add_location(svg1, file$1, 14, 8, 543);
    			attr_dev(div0, "class", div0_class_value = "mt-[" + /*$fieldHeight*/ ctx[1] / 2 + "px] ml-[" + /*$fieldWidth*/ ctx[0] / 2 + "px] fixed z-20");
    			add_location(div0, file$1, 13, 4, 462);
    			attr_dev(div1, "class", "z-50 fixed");
    			add_location(div1, file$1, 16, 4, 752);
    			attr_dev(div2, "class", "fixed");
    			set_style(div2, "width", /*$fieldWidth*/ ctx[0] + " height: " + fieldHeight);
    			add_location(div2, file$1, 9, 0, 200);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(cargoonfield, div1, null);
    			append_dev(div1, t2);
    			mount_component(robot, div1, null);
    			current = true;
    		},
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$fieldHeight, $fieldWidth*/ 3 && div0_class_value !== (div0_class_value = "mt-[" + /*$fieldHeight*/ ctx[1] / 2 + "px] ml-[" + /*$fieldWidth*/ ctx[0] / 2 + "px] fixed z-20")) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('hubSize' in $$props) $$invalidate(2, hubSize = $$props.hubSize);
    	};
    	...
    	return [$fieldWidth, $fieldHeight, hubSize];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "mt-[" + /*yOff*/ ctx[0] + "px] fixed");
    			add_location(div, file, 7, 0, 207);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('xOff' in $$props) xOff = $$props.xOff;
    	};
