...
var app = (function () {
    ...
    var css_248z$1 = ".box.svelte-1cc4zlz{--width:100px;--height:100px;position:fixed;width:var(--width);height:var(--height);border-radius:4px;background-color:#ff3e00}";
    styleInject(css_248z$1);

    /* src\Robot.svelte generated by Svelte v3.48.0 */

    const { console: console_1, window: window_1 } = globals;
    const file = "src\\Robot.svelte";

    function create_fragment$1(ctx) {
    	let div0;
    	let t0_value = Math.atan2(window.innerHeight / 2 - /*$coords*/ ctx[1].y - 50, window.innerWidth / 2 - /*$coords*/ ctx[1].x - 50) * (180 / Math.PI) + 90 + "";
    	let t0;
    	let t1;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 190, 0, 4577);
    			attr_dev(path, "stroke-linecap", "round");
    			attr_dev(path, "stroke-linejoin", "round");
    			attr_dev(path, "d", "M9 11l3-3m0 0l3 3m-3-3v8m0-13a9 9 0 110 18 9 9 0 010-18z");
    			add_location(path, file, 201, 8, 5202);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "class", "h-[70px]");
    			attr_dev(svg, "fill", "none");
    			attr_dev(svg, "viewBox", "0 0 24 24");
    			attr_dev(svg, "stroke", "currentColor");
    			attr_dev(svg, "stroke-width", "2");
    			set_style(svg, "transform", "rotate(" + (/*rot*/ ctx[0] * -1 + Math.atan2(window.innerHeight / 2 - /*$coords*/ ctx[1].y - 50, window.innerWidth / 2 - /*$coords*/ ctx[1].x - 50) * (180 / Math.PI) + 90) + "deg)");
    			add_location(svg, file, 200, 4, 4920);
    			attr_dev(div1, "class", "box grid h-screen place-items-center svelte-1cc4zlz");
    			set_style(div1, "transform", "translate(" + /*$coords*/ ctx[1].x + "px," + /*$coords*/ ctx[1].y + "px) rotate(" + /*rot*/ ctx[0] + "deg)");
    			add_location(div1, file, 196, 0, 4775);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "keydown", /*on_key_down*/ ctx[3], false, false, false),
    					listen_dev(window_1, "keyup", /*on_key_up*/ ctx[4], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$coords*/ 2 && t0_value !== (t0_value = Math.atan2(window.innerHeight / 2 - /*$coords*/ ctx[1].y - 50, window.innerWidth / 2 - /*$coords*/ ctx[1].x - 50) * (180 / Math.PI) + 90 + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*rot, $coords*/ 3) {
    				set_style(svg, "transform", "rotate(" + (/*rot*/ ctx[0] * -1 + Math.atan2(window.innerHeight / 2 - /*$coords*/ ctx[1].y - 50, window.innerWidth / 2 - /*$coords*/ ctx[1].x - 50) * (180 / Math.PI) + 90) + "deg)");
    			}

    			if (dirty & /*$coords, rot*/ 3) {
    				set_style(div1, "transform", "translate(" + /*$coords*/ ctx[1].x + "px," + /*$coords*/ ctx[1].y + "px) rotate(" + /*rot*/ ctx[0] + "deg)");
    			}
    		},
    		i: noop,
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let milliCount = 0;
    	const countUp = () => $$invalidate(5, milliCount += 1);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('milliCount' in $$props) $$invalidate(5, milliCount = $$props.milliCount);
    	};
    	...
    	return [rot, $coords, coords, on_key_down, on_key_up, milliCount];
    }
