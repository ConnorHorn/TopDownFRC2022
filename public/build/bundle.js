...
var app = (function () {
    ...
    const file$2 = "src\\ShotCargo.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$2, 54, 0, 1846);
    ...
    class ShotCargo extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*ballSlot*/ ctx[8] === undefined && !('ballSlot' in props)) {
    			console_1$1.warn("<ShotCargo> was created without expected prop 'ballSlot'");
    		}
    	}
    ...
    function create_if_block_3(ctx) {
    	...
    	shotcargo = new ShotCargo({
    			props: {
    				startX: /*$ball1Coords*/ ctx[5].x,
    				startY: /*$ball1Coords*/ ctx[5].y,
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty[0] & /*$ball1Coords*/ 32) shotcargo_changes.startX = /*$ball1Coords*/ ctx[5].x;
    			if (dirty[0] & /*$ball1Coords*/ 32) shotcargo_changes.startY = /*$ball1Coords*/ ctx[5].y;
    ...
    function create_fragment$1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block0 = !/*$ballSlot1*/ ctx[6] && create_if_block_3(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(svg, "transform", "rotate(" + (/*rot*/ ctx[0] * -1 + Math.atan2(window.innerHeight / 2 - /*$coords*/ ctx[2].y - 50, window.innerWidth / 2 - /*$coords*/ ctx[2].x - 50) * (180 / Math.PI) + 90) + "deg)");
    			add_location(svg, file$1, 265, 4, 7334);
    			attr_dev(div1, "class", "box grid h-screen place-items-center svelte-1fgtq5x");
    			set_style(div1, "transform", "translate(" + /*$coords*/ ctx[2].x + "px," + /*$coords*/ ctx[2].y + "px) rotate(" + /*rot*/ ctx[0] + "deg)");
    			add_location(div1, file$1, 261, 0, 7189);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window_1, "keydown", /*on_key_down*/ ctx[17], false, false, false),
    					listen_dev(window_1, "keyup", /*on_key_up*/ ctx[18], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, ballSlot1, $$value => $$invalidate(6, $ballSlot1 = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	component_subscribe($$self, ball1Coords, value => $$invalidate(5, $ball1Coords = value));
    	...
    	let milliCount = 0;
    	const countUp = () => $$invalidate(19, milliCount += 1);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Robot> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('centerCoords' in $$props) $$invalidate(16, centerCoords = $$props.centerCoords);
    		...
    		if ('milliCount' in $$props) $$invalidate(19, milliCount = $$props.milliCount);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*milliCount*/ 524288) {
    			{
    				calcMovement();
    				calcRotation();
    			}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file, 7, 106, 260);
    			attr_dev(svg, "viewBox", "0 0 " + /*hubSize*/ ctx[0] + " " + /*hubSize*/ ctx[0]);
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "class", "fixed overflow-visible");
    			add_location(svg, file, 7, 0, 154);
