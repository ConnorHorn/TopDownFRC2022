...
var app = (function () {
    ...
    */
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, vizRing, $$value => $$invalidate(30, $vizRing = $$value));
    	validate_store(ballsInRobot, 'ballsInRobot');
    	component_subscribe($$self, ballsInRobot, $$value => $$invalidate(5, $ballsInRobot = $$value));
    	validate_store(storeTurretAngle, 'storeTurretAngle');
    	component_subscribe($$self, storeTurretAngle, $$value => $$invalidate(32, $storeTurretAngle = $$value));
    	validate_store(vizRingSize, 'vizRingSize');
    	component_subscribe($$self, vizRingSize, $$value => $$invalidate(33, $vizRingSize = $$value));
    	validate_store(fieldWidth, 'fieldWidth');
    	component_subscribe($$self, fieldWidth, $$value => $$invalidate(34, $fieldWidth = $$value));
    	validate_store(fieldHeight, 'fieldHeight');
    	component_subscribe($$self, fieldHeight, $$value => $$invalidate(35, $fieldHeight = $$value));
