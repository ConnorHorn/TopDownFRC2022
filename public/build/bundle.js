...
var app = (function () {
    ...
    */
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle, file$4, 71, 0, 2351);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let $matchTime;
    	let $ballsInRobot;
    	let $storeTurretAngle;
    	validate_store(fieldBallCount, 'fieldBallCount');
    	component_subscribe($$self, fieldBallCount, $$value => $$invalidate(14, $fieldBallCount = $$value));
    	validate_store(score, 'score');
    	component_subscribe($$self, score, $$value => $$invalidate(15, $score = $$value));
    	validate_store(matchTime, 'matchTime');
    	component_subscribe($$self, matchTime, $$value => $$invalidate(16, $matchTime = $$value));
    	validate_store(ballsInRobot, 'ballsInRobot');
    	component_subscribe($$self, ballsInRobot, $$value => $$invalidate(17, $ballsInRobot = $$value));
    	validate_store(storeTurretAngle, 'storeTurretAngle');
    	component_subscribe($$self, storeTurretAngle, $$value => $$invalidate(18, $storeTurretAngle = $$value));
    	...
    	console.log(angle);
    	const countUp = () => $$invalidate(9, milliCount += pace);
    	onInterval(countUp, 1);
    	set_store_value(ballsInRobot, $ballsInRobot--, $ballsInRobot);
    	...
    	return [drawX, drawY, ballSize, startX, startY, endX, endY, miss, id, milliCount];
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(circle, "fill", "red");
    			add_location(circle, file$3, 138, 0, 4029);
    			attr_dev(svg, "id", "Layer_1");
    			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg, "xmlns:xlink", "http://www.w3.org/1999/xlink");
    ...
    // (449:0) {#each ballsShot as ball (ball.id)}
    function create_each_block$1(key_2, ctx) {
    	...
    	shotcargo = new ShotCargo({
    			props: {
    				startX: /*ball*/ ctx[66].startX,
    				startY: /*ball*/ ctx[66].startY,
    				endX: /*ball*/ ctx[66].endX,
    				endY: /*ball*/ ctx[66].endY,
    				miss: /*ball*/ ctx[66].miss,
    				id: /*ball*/ ctx[66].id
    			},
    			$$inline: true
    		});

    	shotcargo.$on("scored", /*cargoScored*/ ctx[10]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.startX = /*ball*/ ctx[66].startX;
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.startY = /*ball*/ ctx[66].startY;
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.endX = /*ball*/ ctx[66].endX;
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.endY = /*ball*/ ctx[66].endY;
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.miss = /*ball*/ ctx[66].miss;
    			if (dirty[0] & /*ballsShot*/ 8) shotcargo_changes.id = /*ball*/ ctx[66].id;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(449:0) {#each ballsShot as ball (ball.id)}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const get_key = ctx => /*ball*/ ctx[66].id;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(svg0, file$2, 424, 4, 13462);
    			attr_dev(circle, "cx", "10.5");
    			attr_dev(circle, "cy", "10.5");

    			attr_dev(circle, "fill", circle_fill_value = /*$ballsInRobot*/ ctx[5] > 0
    			? /*$ballsInRobot*/ ctx[5] > 1 ? "green" : "yellow"
    			: "none");
    			...
    			add_location(circle, file$2, 433, 8, 14007);
    			...
    			add_location(svg2, file$2, 439, 8, 14247);
    			add_location(intake_1, file$2, 438, 4, 14229);
    			...
    			add_location(div1, file$2, 420, 0, 13300);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(window, "keydown", /*on_key_down*/ ctx[8], false, false, false),
    					listen_dev(window, "keyup", /*on_key_up*/ ctx[9], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty[0] & /*$ballsInRobot*/ 32) set_data_dev(t0, /*$ballsInRobot*/ ctx[5]);

    			if (!current || dirty[0] & /*turretLockedOn*/ 4 && svg0_stroke_value !== (svg0_stroke_value = /*turretLockedOn*/ ctx[2] ? "green" : "white")) {
    				attr_dev(svg0, "stroke", svg0_stroke_value);
    			}

    			if (!current || dirty[0] & /*turretAngle*/ 2) {
    				set_style(svg0, "transform", "rotate(" + /*turretAngle*/ ctx[1] + "deg)");
    			}

    			if (!current || dirty[0] & /*$ballsInRobot*/ 32 && circle_fill_value !== (circle_fill_value = /*$ballsInRobot*/ ctx[5] > 0
    			? /*$ballsInRobot*/ ctx[5] > 1 ? "green" : "yellow"
    			: "none")) {
    				attr_dev(circle, "fill", circle_fill_value);
    			}

    			if (!current || dirty[0] & /*$coords, rot*/ 17) {
    				set_style(div1, "transform", "translate(" + (/*$coords*/ ctx[4].x - 65) + "px," + (/*$coords*/ ctx[4].y - 65) + "px) rotate(" + /*rot*/ ctx[0] + "deg)");
    			}

    			if (dirty[0] & /*ballsShot, cargoScored*/ 1032) {
    				each_value = /*ballsShot*/ ctx[3];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$1, get_key);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, vizRing, $$value => $$invalidate(28, $vizRing = $$value));
    	validate_store(ballsInRobot, 'ballsInRobot');
    	component_subscribe($$self, ballsInRobot, $$value => $$invalidate(5, $ballsInRobot = $$value));
    	validate_store(storeTurretAngle, 'storeTurretAngle');
    	component_subscribe($$self, storeTurretAngle, $$value => $$invalidate(30, $storeTurretAngle = $$value));
    	validate_store(vizRingSize, 'vizRingSize');
    	component_subscribe($$self, vizRingSize, $$value => $$invalidate(31, $vizRingSize = $$value));
    	validate_store(fieldWidth, 'fieldWidth');
    	component_subscribe($$self, fieldWidth, $$value => $$invalidate(32, $fieldWidth = $$value));
    	validate_store(fieldHeight, 'fieldHeight');
    	component_subscribe($$self, fieldHeight, $$value => $$invalidate(33, $fieldHeight = $$value));
    	validate_store(globalSpeedY, 'globalSpeedY');
    	component_subscribe($$self, globalSpeedY, $$value => $$invalidate(34, $globalSpeedY = $$value));
    	validate_store(globalSpeedX, 'globalSpeedX');
    	component_subscribe($$self, globalSpeedX, $$value => $$invalidate(35, $globalSpeedX = $$value));
    	validate_store(ballBoxBackRight, 'ballBoxBackRight');
    	component_subscribe($$self, ballBoxBackRight, $$value => $$invalidate(36, $ballBoxBackRight = $$value));
    	validate_store(ballBoxBackLeft, 'ballBoxBackLeft');
    	component_subscribe($$self, ballBoxBackLeft, $$value => $$invalidate(37, $ballBoxBackLeft = $$value));
    	validate_store(ballBoxFrontRight, 'ballBoxFrontRight');
    	component_subscribe($$self, ballBoxFrontRight, $$value => $$invalidate(38, $ballBoxFrontRight = $$value));
    	validate_store(ballBoxFrontLeft, 'ballBoxFrontLeft');
    	component_subscribe($$self, ballBoxFrontLeft, $$value => $$invalidate(39, $ballBoxFrontLeft = $$value));
    	validate_store(globalY, 'globalY');
    	component_subscribe($$self, globalY, $$value => $$invalidate(40, $globalY = $$value));
    	validate_store(globalX, 'globalX');
    	component_subscribe($$self, globalX, $$value => $$invalidate(41, $globalX = $$value));
    	validate_store(globalAngle, 'globalAngle');
    	component_subscribe($$self, globalAngle, $$value => $$invalidate(42, $globalAngle = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	component_subscribe($$self, centerCoords, value => $$invalidate(29, $centerCoords = value));
    	...
    	function calcRotation() {
    		...
    		set_store_value(globalAngle, $globalAngle = rot, $globalAngle);
    	}
    	...
    	function calcMovement() {
    		...
    		set_store_value(globalSpeedY, $globalSpeedY = yValue * speedModifier, $globalSpeedY);
    	}
    	...
    	function manageTurret() {
    		...
    		if (distanceFromGoal < $vizRingSize / 2) {
    			...
    			if (calcTurretDirection(turretGoal, turretAngle)) {
    				$$invalidate(1, turretAngle += turretSpeed);
    		...
    		if (turretAngle < 0) {
    			$$invalidate(1, turretAngle += 360);
    		}

    		$$invalidate(1, turretAngle = turretAngle % 360);
    		...
    		if (Math.min(Math.abs(turretAngle - turretGoal), Math.abs(360 - turretGoal + turretAngle)) < turretSpeed * 3 && distanceFromGoal < $vizRingSize / 2) {
    			$$invalidate(1, turretAngle = turretGoal);
    			$$invalidate(2, turretLockedOn = true);
    		} else {
    			$$invalidate(2, turretLockedOn = false);
    		}
    		...
    		set_store_value(storeTurretAngle, $storeTurretAngle = turretAngle + rot, $storeTurretAngle);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('ball1Coords' in $$props) ball1Coords = $$props.ball1Coords;
    		if ('ball2Coords' in $$props) ball2Coords = $$props.ball2Coords;
    		if ('ball3Coords' in $$props) ball3Coords = $$props.ball3Coords;
    		if ('ball4Coords' in $$props) ball4Coords = $$props.ball4Coords;
    		if ('centerCoords' in $$props) $$invalidate(7, centerCoords = $$props.centerCoords);
    		...
    		if ('turretLockedOn' in $$props) $$invalidate(2, turretLockedOn = $$props.turretLockedOn);
    		if ('ballShotPace' in $$props) ballShotPace = $$props.ballShotPace;
    		if ('lastBallShot' in $$props) lastBallShot = $$props.lastBallShot;
    		if ('ballsShot' in $$props) $$invalidate(3, ballsShot = $$props.ballsShot);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*milliCount*/ 2048) {
    			{
    				calcMovement();
    				calcRotation();
    				manageIntake();
    ...
    // (84:0) {#each floorBalls as ball (ball)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const cargo_changes = {};
    			if (dirty & /*floorBalls*/ 1) cargo_changes.coords = /*ball*/ ctx[15];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(84:0) {#each floorBalls as ball (ball)}",
    		ctx
    	});
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $ballsInRobot;
    	validate_store(fieldBallCount, 'fieldBallCount');
    	component_subscribe($$self, fieldBallCount, $$value => $$invalidate(3, $fieldBallCount = $$value));
    	validate_store(ballBoxBackLeft, 'ballBoxBackLeft');
    	component_subscribe($$self, ballBoxBackLeft, $$value => $$invalidate(4, $ballBoxBackLeft = $$value));
    	validate_store(ballBoxBackRight, 'ballBoxBackRight');
    	component_subscribe($$self, ballBoxBackRight, $$value => $$invalidate(5, $ballBoxBackRight = $$value));
    	validate_store(ballBoxFrontRight, 'ballBoxFrontRight');
    	component_subscribe($$self, ballBoxFrontRight, $$value => $$invalidate(6, $ballBoxFrontRight = $$value));
    	validate_store(ballBoxFrontLeft, 'ballBoxFrontLeft');
    	component_subscribe($$self, ballBoxFrontLeft, $$value => $$invalidate(7, $ballBoxFrontLeft = $$value));
    	validate_store(fieldHeight, 'fieldHeight');
    	component_subscribe($$self, fieldHeight, $$value => $$invalidate(8, $fieldHeight = $$value));
    	validate_store(fieldWidth, 'fieldWidth');
    	component_subscribe($$self, fieldWidth, $$value => $$invalidate(9, $fieldWidth = $$value));
    	validate_store(ballsInRobot, 'ballsInRobot');
    	component_subscribe($$self, ballsInRobot, $$value => $$invalidate(10, $ballsInRobot = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*milliCount, floorBalls*/ 5) {
    			{
    				occupyField();
    				clearIllegalBalls();
    			}
    	...
    	return [floorBalls, handleIntake, milliCount];
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 50, 8, 2438);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 59, 4, 2724);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "width", /*$fieldWidth*/ ctx[1]);
    			attr_dev(rect, "height", /*$fieldHeight*/ ctx[2]);
    			set_style(rect, "fill", "black");
    			set_style(rect, "stroke-width", "3");
    			set_style(rect, "stroke", "white");
    			add_location(rect, file$1, 21, 8, 697);
    			attr_dev(svg0, "width", /*$fieldWidth*/ ctx[1]);
    			attr_dev(svg0, "height", /*$fieldHeight*/ ctx[2]);
    			attr_dev(svg0, "class", "fixed");
    			add_location(svg0, file$1, 20, 4, 626);
    			attr_dev(div0, "class", "fixed");
    			set_style(div0, "transform", "translate(" + (/*$score*/ ctx[3].toString().length * -29 + 2) + "px,-85px)");
    			add_location(div0, file$1, 25, 12, 954);
    			attr_dev(path0, "stroke-linecap", "round");
    			attr_dev(path0, "stroke-linejoin", "round");
    			...
    			add_location(path0, file$1, 33, 20, 1397);
    			attr_dev(svg1, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg1, "class", "");
    			...
    			attr_dev(svg1, "stroke-width", "3");
    			add_location(svg1, file$1, 32, 16, 1262);
    			attr_dev(button0, "class", "btn btn-circle btn-accent btn-lg");
    			add_location(button0, file$1, 31, 12, 1195);
    			attr_dev(div1, "class", "fixed z-20");
    			set_style(div1, "transform", "translate(-70px,-1px)");
    			add_location(div1, file$1, 29, 8, 1109);
    			attr_dev(path1, "stroke-linecap", "round");
    			attr_dev(path1, "stroke-linejoin", "round");
    			...
    			add_location(path1, file$1, 42, 20, 1930);
    			attr_dev(svg2, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg2, "class", "");
    			attr_dev(svg2, "fill", "none");
    			attr_dev(svg2, "viewBox", "0 0 24 24");
    			...
    			attr_dev(circle, "stroke-linejoin", "round");
    			add_location(circle, file$1, 48, 84, 2278);
    			attr_dev(svg3, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(svg3, "class", "fixed overflow-visible z-10");
    			add_location(svg3, file$1, 48, 8, 2202);
    			attr_dev(div3, "class", "fixed z-20 text-8xl text-white font-bold");
    			set_style(div3, "transform", "translate(" + /*$fieldWidth*/ ctx[1] / 2 + "px," + /*$fieldHeight*/ ctx[2] / 2 + "px)");
    			add_location(div3, file$1, 23, 4, 812);
    			attr_dev(div4, "class", "z-50 fixed");
    			add_location(div4, file$1, 54, 4, 2627);
    			attr_dev(div5, "class", "fixed text-center overflow-hidden");
    			set_style(div5, "width", /*$fieldWidth*/ ctx[1] + " height: " + fieldHeight);
    			add_location(div5, file$1, 19, 0, 521);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*$fieldHeight*/ 4) {
    				attr_dev(rect, "height", /*$fieldHeight*/ ctx[2]);
    			}
    			...
    			if (!current || dirty & /*$score*/ 8) set_data_dev(t1, /*$score*/ ctx[3]);

    			if (!current || dirty & /*$score*/ 8) {
    				set_style(div0, "transform", "translate(" + (/*$score*/ ctx[3].toString().length * -29 + 2) + "px,-85px)");
    			}
    			...
    			if (!current || dirty & /*$fieldWidth, $fieldHeight*/ 6) {
    				set_style(div3, "transform", "translate(" + /*$fieldWidth*/ ctx[1] / 2 + "px," + /*$fieldHeight*/ ctx[2] / 2 + "px)");
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let $vizRingSize;
    	validate_store(matchTime, 'matchTime');
    	component_subscribe($$self, matchTime, $$value => $$invalidate(7, $matchTime = $$value));
    	validate_store(fieldWidth, 'fieldWidth');
    	component_subscribe($$self, fieldWidth, $$value => $$invalidate(1, $fieldWidth = $$value));
    	validate_store(fieldHeight, 'fieldHeight');
    	component_subscribe($$self, fieldHeight, $$value => $$invalidate(2, $fieldHeight = $$value));
    	validate_store(score, 'score');
  ...
  `);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "fixed");
    			set_style(div, "transform", "translate(" + /*xOff*/ ctx[1] + "px," + /*yOff*/ ctx[0] + "px)");
    			add_location(div, file, 30, 0, 958);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('yOff' in $$props) $$invalidate(0, yOff = $$props.yOff);
    		if ('xOff' in $$props) $$invalidate(1, xOff = $$props.xOff);
    	};
