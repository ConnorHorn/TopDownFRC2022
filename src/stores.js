...
//---------------------------------------------------
//Generic Robot
export const robots=writable([])
export const ballsInRobots=writable([]);
export const intakes=writable([]);
export const turretAngles=writable([]);
export const robotCoords=writable([]);
export const robotAngles=writable([]);
export const robotBallBoxes=writable([]);
export const robotSpeeds=writable([]);
export const robotColors=writable([]);
export const robotConfigs=writable([]);
